...
type DestinationSpecApplyConfiguration struct {
	...
	SourceFilter    *SourceFilterApplyConfiguration `json:"sourceFilter,omitempty"`
}
...
func (b *DestinationSpecApplyConfiguration) WithSourceFilter(value *SourceFilterApplyConfiguration) *DestinationSpecApplyConfiguration {
